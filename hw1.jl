...
function mean(x)
	return (ones(length(x))'x) / length(x)
end
...
function vecvec_to_matrix(vecvec)
	# https://stackoverflow.com/questions/26673412/how-to-convert-an-array-of-array-into-a-matrix
...
function matrix_to_vecvec(matrix)
	# https://stackoverflow.com/questions/38833324/how-to-convert-a-matrix-into-a-vector-of-vectors/38835552
